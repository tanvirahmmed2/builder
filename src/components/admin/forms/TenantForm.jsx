    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs mb-6">
      <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-800">Provision Tenant Portfolio Space</h3>
            <p className="text-xs text-slate-500">Create a distinct tenant website container, assign subdomains and domains.</p>
          </div>
        </div>
        {onCancel && (
          <button
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1">Site / Tenant Name</label>
            <input
              type="text"
              required
        ...
        <div className="flex items-center gap-2 pt-1">
          ...
          />
          <label htmlFor="tenant_published" className="text-xs font-semibold text-slate-700 cursor-pointer">
