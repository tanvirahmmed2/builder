...
import HomeBlogCard from '@/components/home/cards/BlogCard';
        ...
        {loading ? (
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center my-8 shadow-xs max-w-lg mx-auto">
            ...
            <p className="text-xs text-slate-500 mt-1.5 max-w-sm mx-auto leading-relaxed">
              {search
                ? `No articles matched "${search}". Try checking for typos or searching a different term.`
                : 'Articles published in the developer portal will appear here.'}
            </p>
            {search && (
              <button
                type="button"
