    ...
    <div className="w-full min-h-screen bg-slate-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-5xl font-semibold text-slate-900 tracking-tight">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white border border-slate-200 rounded-3xl space-y-3 p-8">
            ...
            <h3 className="font-semibold text-slate-800 text-base">No tutorials matched your search</h3>
        ...
        <div className="rounded-3xl bg-gradient-to-r from-slate-900 to-indigo-950 p-8 sm:p-10 text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div className="space-y-2 text-center sm:text-left">
            <h3 className="text-xl sm:text-2xl font-semibold">Still have questions?</h3>
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <Link
              href="/contact"
              className="px-5 py-2.5 rounded-xl bg-secondary hover:bg-secondary/90 text-white text-xs font-semibold transition-all shadow-md"
            >
              Contact Support
            </Link>
          </div>
