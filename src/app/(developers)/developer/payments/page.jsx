...
import PaymentForm from '@/components/developer/forms/PaymentForm';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200 rounded-2xl p-6 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500">Financial records, checkout revenue, subscription charges, and refund history.</p>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-xs overflow-hidden">
        <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-50/50">
          <div className="relative w-full sm:w-72">
            ...
            <input
              type="text"
              placeholder="Search payments by txn ID, creator ID, or method..."
              value={searchTerm}
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-700">
              {loading ? (
                ...
                <tr>
                  <td colSpan={8} className="py-12 text-center text-slate-400">No payment transactions found.</td>
                </tr>
              ) : (
                filtered.map((p) => (
