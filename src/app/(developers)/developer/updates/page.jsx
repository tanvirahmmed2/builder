    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200 rounded-2xl p-6 shadow-xs">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Product Updates & Changelog</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl px-4 py-2.5 flex items-center justify-between shadow-xs">
          <span className="text-xs font-medium text-slate-500">Total Published Updates</span>
          <span className="text-base font-bold text-slate-900">{updates.length}</span>
        </div>
      </div>
      ...
      {loading ? (
        <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center flex flex-col items-center justify-center gap-3">
          ...
          <p className="text-xs text-slate-500 font-medium">Loading product updates...</p>
        </div>
        ...
        <div className="bg-white border border-dashed border-slate-200 rounded-2xl p-12 text-center">
          ...
          <h3 className="text-sm font-bold text-slate-800 mb-1">No Updates Found</h3>
          <p className="text-xs text-slate-500 max-w-sm mx-auto mb-4">
            {searchTerm
              ? `No updates matched "${searchTerm}".`
              : 'No product changelog updates published yet.'}
          </p>
        ...
        <div className="space-y-4">
          {filteredUpdates.map((item) => (
            <div
              key={item.id}
              className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs hover:border-slate-300 transition-all flex flex-col md:flex-row md:items-start justify-between gap-5"
            >
              <div className="flex-1 min-w-0">
                ...
                <div
                  className="prose prose-xs max-w-none text-slate-600 line-clamp-3 bg-slate-50/60 p-3 rounded-xl border border-slate-100"
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-xs overflow-y-auto animate-fadeIn">
          <div className="bg-white border border-slate-200 rounded-2xl max-w-3xl w-full p-6 shadow-2xl space-y-4 my-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-slate-800 text-xs font-mono focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600"
                  />
                </div>
              </div>
